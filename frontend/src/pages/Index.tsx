...
const Index: React.FC = () => {
    ...
    const user_register = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        try {
            console.log(state);
            setLoader(true);
    ...
    const user_login = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        try {
            console.log(state);
            setLoader(true);
                ...
                <div className='w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative'>
                    ...
                    {type === 'signin' && (
                        <form onSubmit={user_login}>
                            ...
                            <div>
                                <button disabled={loader} className='px-3 py-2 rounded-md bg-purple-500 w-full outline-none hover:bg-purple-600 text-white'>{loader ? 'loading..' : 'Signin'}</button>
                            </div>
